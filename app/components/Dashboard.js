...
export default function Dashboard(){
 ...
 return <main className="shell">
  <header className="topbar"><div className="brandBlock"><img src="/kaspa-logo.svg" className="kaspaMark" alt="Kaspa"/><div><div className="kaspaWord">KASPA</div><div className="monitorWord">HOLDER MONITOR</div></div></div><div className="headerTools"><span className="versionBadge">v2.2.15</span><select className="lang" value={lang} onChange={changeLang} aria-label="Language"><option value="ja">日本語</option><option value="en">English</option><option value="ko">한국어</option><option value="zh">中文</option><option value="es">Español</option></select><img className="headerTechbitLogo" src="/techbit-logo.png" alt="TechBit · Crypto × Data × Future"/></div></header>
  ...
  <footer><div className="footerBrand"><img src="/kaspa-logo.svg" alt="Kaspa"/><div><b>@TechBit</b><span>KASPA ON-CHAIN ANALYTICS</span></div></div><p>{t.foot}</p><p>{t.source}: Kaspalytics · CoinGecko<br/>{t.updated}: {holder?.capturedAt?new Date(holder.capturedAt).toLocaleString(LOCALES[lang]):'—'}</p></footer>
</main>
}
